...
class EarlyStopping:
    """Stop training if eval reward does not improve for `patience` rounds."""
...
def train_gail(
    ...
    logging.info("Loaded %d trajectories, %d transitions", len(demos), n_transitions)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", default="model/gail_learner.zip")
    parser.add_argument("--rout", default="model/gail_learner_reward.pt")
